...
function Index({ coin, setCoin, Patent, patents, setPatents }) {

  let addPatent = (patentName, patentPrice, productPrice) => {
    let newPatents = [
      ...patents,
      new Patent(patentName, patentPrice, productPrice),
    ];
          ...
          <div className="row my-4 g-4">
            <div className="col-lg-3 col-md-6">
              <div className="card text-center">
                <img
                  src="https://storage.acerapps.io/app-1528/out/pt.jpg"
            ...
            <div className="col-lg-3 col-md-6">
              <div className="card text-center">
                ...
                <div className="card-footer">
                  <span>{formatCoin(100)}</span>
                  <button
                    className="btn btn-success w-100"
                    disabled={coin >= 100 ? false : true}
                    onClick={
                      coin >= 100
                        ? () => addPatent("Default Patent 2", 100, 2)
            ...
            <div className="col-lg-3 col-md-6">
              <div className="card text-center">
                ...
                <div className="card-footer">
                  <span>{formatCoin(5000)}</span>
                  <button
                    className="btn btn-success w-100"
                    disabled={coin >= 5000 ? false : true}
                    onClick={
                      coin >= 5000
                        ? () => addPatent("Başlangıç Patent", 5000, 10)
                        : () => console.log("Geçersiz İşlem")
                    }
                  >
                    Patenti Al
            ...
            <div className="col-lg-3 col-md-6">
              <div className="card text-center">
                ...
                <div className="card-footer">
                  <span>{formatCoin(15000)}</span>
                  <button
                    className="btn btn-success w-100"
                    disabled={coin >= 15000 ? false : true}
                    onClick={
                      coin >= 15000
                        ? () => addPatent("Orta Patent", 15000, 20)
                        : () => console.log("Geçersiz İşlem")
                    }
                  >
                    Patenti Al
            ...
            <div className="col-lg-3 col-md-6">
              <div className="card text-center">
                ...
                <div className="card-footer">
                  <span>{formatCoin(30000)}</span>
                  <button
                    className="btn btn-success w-100"
                    disabled={coin >= 30000 ? false : true}
                    onClick={
                      coin >= 30000
                        ? () => addPatent("Yüksek Patent", 30000, 30)
                        : () => console.log("Geçersiz İşlem")
                    }
                  >
                    Patenti Al
            ...
            <div className="col-lg-3 col-md-6">
              <div className="card text-center">
                ...
                <div className="card-footer">
                  <span>{formatCoin(60000)}</span>
                  <button
                    className="btn btn-success w-100"
                    disabled={coin >= 60000 ? false : true}
                    onClick={
                      coin >= 60000
                        ? () => addPatent("Gelişmiş Patent", 60000, 50)
                        : () => console.log("Geçersiz İşlem")
                    }
                  >
                    Patenti Al
